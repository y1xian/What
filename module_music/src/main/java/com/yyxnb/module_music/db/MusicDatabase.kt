 ...
 */
@Database(entities = [MusicBean::class, MusicFavouriteBean::class, MusicRecordBean::class, MusicLocalBean::class], version = 1, exportSchema = false)
...
abstract class MusicDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        //room默认数据库的查询是不能在主线程中执行的，除非这样设置
        //不想提供migration，而且希望更新版本之后清空数据库
        @JvmStatic
        val instance: MusicDatabase?
            get() {
                if (INSTANCE == null) {
