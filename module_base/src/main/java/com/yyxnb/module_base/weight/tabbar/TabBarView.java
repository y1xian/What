package com.yyxnb.module_base.weight.tabbar;
...
public class TabBarView extends LinearLayout {
    ...
    private void laodAttrs(Context context, AttributeSet attrs) {
        ...
        iconPadding = typedArray.getDimensionPixelOffset(R.styleable.TabBar_tabIconPadding, iconPadding);
        textSize = typedArray.getDimensionPixelOffset(R.styleable.TabBar_tabTextSize, textSize);
        tabPaddingVertical = typedArray.getDimensionPixelOffset(R.styleable.TabBar_tabPaddingVertical, tabPaddingVertical);
        focusColor = typedArray.getColor(R.styleable.TabBar_tabFocusColor, focusColor);
        normalColor = typedArray.getColor(R.styleable.TabBar_tabNormalColor, normalColor);
        tabClickBackground = typedArray.getInt(R.styleable.TabBar_tabClickBackground, TabClickBackgroundValue.RIPPLE.ordinal());
        paddingNavigationBar = typedArray.getBoolean(R.styleable.TabBar_tabPaddingNavigationBar, paddingNavigationBar);
        noDyeing = typedArray.getBoolean(R.styleable.TabBar_tabNoDyeing, noDyeing);
        noSelect = typedArray.getBoolean(R.styleable.TabBar_tabNoSelect, noSelect);
        splitLine = typedArray.getResourceId(R.styleable.TabBar_tabSplitLine, splitLine);
        unreadBackground = typedArray.getResourceId(R.styleable.TabBar_tabUnreadBackground, unreadBackground);
