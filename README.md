...
-  自行查看 `libs`目录，工具包都在其包下。具体实现方法可在 `module-widget` 模块下查看 (不完全)


开发环境：Android Studio 4.1.1 、gradle 6.6 、kotlin 1.4.30 、JDK 1.8 、SdkVersion support 28 - AndroidX 30

- 主干为Java + AndroidX （ 得跟上jio步

- Java + support版本的看 [java-support](https://github.com/y1xian/What/tree/java-support) 分支；

- 最新AndroidX + Kotlin版本的看 [What-Kotlin](https://github.com/y1xian/What-Kotlin) ，**【 kotlin版本会比java版本更新慢，重心还在java版本上（kotlin也就图一乐，吃饭还是得靠java 】**；
