package com.yyxnb.lib_widget.interfaces;
 ...
 * <p>
 * LifecycleObserver接口（ Lifecycle观察者）：实现该接口的类，通过注解的方式，可以通过被 {@link android.arch.lifecycle.Lifecycle#addObserver(LifecycleObserver)} 方法注册,
 ...
 * {@link android.arch.lifecycle.Lifecycle.Event}
 * <p>
 ...
 * <p>
 * 注册 {@link android.arch.lifecycle.Lifecycle#addObserver(LifecycleObserver)}
 * 移除 {@link android.arch.lifecycle.Lifecycle#removeObserver(LifecycleObserver)}
